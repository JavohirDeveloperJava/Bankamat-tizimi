...
public class CardPulSolishService {
    ...
    public ApiResponse pul(CardPulSolishDto dto){
        ...
        bancomat.setBalanceBancamat(bancomat.getBalanceBancamat()-dto.getSumma());
        ...
        return new ApiResponse("pul muafaqiyatlik otdi",true);
    }
}
